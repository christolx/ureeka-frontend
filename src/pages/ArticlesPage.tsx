      ...
      <div className="flex flex-col gap-10">
        <div className="flex gap-4 flex-col items-start">
          ...
          <div className="flex gap-2 flex-col">
            <h2 className="text-2xl sm:text-3xl md:text-5xl text-[#3b463b] md:text-5xl tracking-tighter max-w-xl font-regular text-left">
              Articles For <span className="text-[#D1913C] font-serif text-3xl sm:text-5xl">You</span>
            </h2>
          </div>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
          <div className="flex flex-col gap-2 hover:opacity-75 cursor-pointer transition-all duration-150">
            <div className="bg-muted rounded-md aspect-video mb-2 overflow-hidden">
                <img className="rounded-md w-full h-full object-cover" src="/images/donasi-makanan-untuk-anak-anak-jalan-di-jakarta_169.jpeg" />
            </div>
          ...
          <div className="flex flex-col gap-2 hover:opacity-75 cursor-pointer transition-all duration-150">
            <div className="bg-muted rounded-md aspect-video mb-2 overflow-hidden">
              <img className="rounded-md w-full h-full object-cover" src="/images/5-makanan-ini-cocok-untuk-sumbangan-korban-bencana-alam-2.jpeg" />
            </div>
            <h3 className="text-xl tracking-tight">
          ...
          <div className="flex flex-col gap-2 hover:opacity-75 cursor-pointer transition-all duration-150">
            <div className="bg-muted rounded-md aspect-video mb-2 overflow-hidden">
              <img className="rounded-md w-full h-full object-cover" src="/images/makanan-gratis-untuk-4000-orang.webp" />
            </div>
            <h3 className="text-xl tracking-tight">
          ...
          <div className="flex flex-col gap-2 hover:opacity-75 cursor-pointer transition-all duration-150">
            <div className="bg-muted rounded-md aspect-video mb-2 overflow-hidden">
              <img className="rounded-md w-full h-full object-cover" src="/images/ht2d2di0nr22ofp.jpeg" />
            </div>
            <h3 className="text-xl tracking-tight">
          ...
          <div className="flex flex-col gap-2 hover:opacity-75 cursor-pointer transition-all duration-150">
            <div className="bg-muted rounded-md aspect-video mb-2 overflow-hidden">
              <img className="rounded-md w-full h-full object-cover" src="/images/tips-agar-makanan-tidak-terbuang.webp" />
            </div>
            <h3 className="text-xl tracking-tight">
          ...
          <div className="flex flex-col gap-2 hover:opacity-75 cursor-pointer transition-all duration-150">
            <div className="bg-muted rounded-md aspect-video mb-2 overflow-hidden">
              <img className="rounded-md w-full h-full object-cover" src="/images/warga-berebut-makanan-buka-puasa-di-pemkab-blitar.jpeg" />
            </div>
            <h3 className="text-xl tracking-tight">
