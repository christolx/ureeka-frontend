const About = () => {
    return (
        <div id="about" className="max-w-5xl mx-auto px-4">
            <section id="about" className="text-[#526051] flex flex-col md:flex-row items-center gap-8 p-6 md:p-10 rounded-2xl">
                <img src="/images/food-everyone.jpg" alt="Hunger Awareness" className="w-full md:w-1/2 rounded-xl" />
                <div className="w-full md:w-1/2 text-center md:text-left">
                    <h2 className="text-[#6E826D] text-2xl md:text-3xl font-regular">
            ...
            <div className="mt-10 text-center md:text-left">
                ...
                <div className="flex flex-col md:flex-row justify-between gap-6 mt-6">
                    {/* Card 1 */}
                    <div className="bg-[#FDF7E9] p-6 rounded-xl text-black flex-1 text-center md:text-left">
