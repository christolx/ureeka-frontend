const Donations = () => (
    <div className="w-full mt-10 py-5 lg:py-10 overflow-x-hidden flex items-center max-w-7xl mx-auto rounded-2xl">
        <div className="container py-4 mx-auto">
            <h3 className="text-5xl max-w-lg text-[#3b463b] select-none tracking-tighter font-regular whitespace-nowrap">FIGHTING HUNGER, <span className="text-[#D1913C] font-serif text-5xl">BUILDING HOPE</span></h3>
            <div className="flex flex-wrap mt-6">
                <div className="p-4 md:w-1/3">
                    <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden hover:scale-103 transition-all duration-300">
                        <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="/images/nutritious-food.jpg" alt="blog" />
                        <div className="p-6">
                ...
                <div className="p-4 md:w-1/3">
                    <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden hover:scale-103 transition-all duration-300">
                        <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="/images/volunteer-food-bank.jpg" alt="blog" />
                        <div className="p-6">
                ...
                <div className="p-4 md:w-1/3">
                    <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden hover:scale-103 transition-all duration-300">
                        <img className="lg:h-48 md:h-36 w-full object-cover object-center" src="/images/sustainable-food-programs.jpg" alt="blog"/>
                        <div className="p-6">
